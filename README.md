...
### Как пользоваться проектом?
  ...
  1. Запуск
     ...
     4. Test with only one library - тест только одной библиотеки.
          ...
          ```python
          Which library would you like to test:
          0 - Pandas
          1 - DuckDB
          2 - Postgres
          3 - SQLite
          4 - SQLAlchemy
          Input the number (0/1/2/3/4): 
          ```
  
          1.2. Затем требуется определиться, какой файл Вы будете тестировать - big or tiny.

          1.3. Запускается тест и выводятся результаты.

     0. Exit - конец программы.
